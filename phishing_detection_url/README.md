# Orgiginal work from - https://github.com/gangeshbaskerr/Phishing-Website-Detection/tree/main

# modifications made:
1. modified URL Feature Extraction.ipynb, to filter some data (dont comments not upto date yet)
2. modified web_traffic function, with random number generator, because the web analytics site is not active or working.
